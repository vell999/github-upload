...
FalseSensor::FalseSensor(Location a_location, size_t a_numEvents)
: m_location(a_location)
, m_numEvents(a_numEvents)
{
}

void FalseSensor::Connect(SharedPointer<ISystemConnectApi> a_systemConnectAPI)
{
...
SharedPointer<IEvent> FalseSensor::createEvent()
{
    Topic fireTopic;
    fireTopic.m_type.m_type = "false sensor";
